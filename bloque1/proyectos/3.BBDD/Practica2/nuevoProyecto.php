        ...
        <form action="controlador.php" method="POST" class="p-4 border rounded shadow bg-white">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="number" name="diasTranscurridos" id="diasTranscurridos" class="form-control" min="0"
                placeholder="0">
            </div>
            <div class="col-md-6 mb-3">
              <label for="porcentageCompletado" class="form-label fw-semibold">Porcentaje Completado</label>
              <input type="number" name="porcentageCompletado" id="porcentageCompletado" class="form-control" min="0"
                placeholder="0">
            </div>
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="number" name="importancia" id="importancia" class="form-control" placeholder="1-5" max="5"
              min="1">
          </div>
